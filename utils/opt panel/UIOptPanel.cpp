...
static std::map<UIOptPanel::Type, std::pair<float, std::string>> Timer_Config_Ref {
    ...
    {UIOptPanel::Type::MING,       {25.0f, _xxf::en_trust}},
    {UIOptPanel::Type::PASS,       {25.0f, _xxf::en_pass}},
    {UIOptPanel::Type::PLAY_LIMIT, {20.0f, _xxf::en_trust}},
    {UIOptPanel::Type::PLAY,       {20.0f, _xxf::en_trust}}
};
